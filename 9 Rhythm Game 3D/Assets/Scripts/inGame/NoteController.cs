...
{
    //SO_data sodatas;
    public GameObject _notePrefab; //큐브(노트)를 의미한다
    ...
    [Tooltip("최근 사용된 위치를 피할 개수 (1-3 권장)")]
    public int avoidRecentPositions = 2;
    private List<int> recentUsedPositions = new List<int>();
