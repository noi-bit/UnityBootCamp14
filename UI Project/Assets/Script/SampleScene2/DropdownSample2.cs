...
public class DropdownSample2 : MonoBehaviour
{
    public TMP_Dropdown type;
    public PlayerInfoSample typelist;
    ...
    private void Start()
    {
        ...
        type.ClearOptions();//드롭다운의 Option 명단을 제거하는 코드
        type.AddOptions(typelist.playertype);//준비된 명단에 추가하는 기능
